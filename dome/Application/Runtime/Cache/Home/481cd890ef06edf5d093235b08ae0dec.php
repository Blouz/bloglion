	...
	<div class="main">
				 ...
				 <form action="<?php echo U('Login/login_adm');?>" id="signupForm" method="post">
		                 ...
		                 <input type="text"  placeholder="请输入验证码"  name="code" id="text">
		              	...
		              	<div class="lable-2">
		                 <input type="text"   placeholder="请输入手机号"  name="number" id="number">
							</div>
							<div class="lable-2">
							<h3><span><input  type="button" class="code" value="获取验证码"><span></h3>
						  	</div>
						  	<div class="lable-2">
				<input type="text" class="text"  placeholder="请输入手机号验证码"  name="number_sum" id="number">
							</div>
							<div class="submit">
									<input type="submit"  value="Blog_submit" >
								</div>
									<div class="clear"> </div>
							 </form>
		</div>
