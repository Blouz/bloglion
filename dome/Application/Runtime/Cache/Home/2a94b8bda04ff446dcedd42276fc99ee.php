...
<html xmlns="http://www.onele.cc">
<head>
<base href="/Public/Home/">
    <meta http-equiv="Content-Type" content="text/html; Charset=gb2312">
    <meta http-equiv="Content-Language" content="zh-CN">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
    <title>日落阁 - 一个.PHP程序员的个人博客网站</title>
        ...
        <div class="blog-container">
            ...
            <ul class="layui-nav" lay-filter="nav">
                ...
                <li class="layui-nav-item">
                 ...
                 <li class="layui-nav-item">
                    <a href="<?php echo U('Login/login');?>"><i class="fa fa-info fa-fw"></i>&nbsp;登录</a>
                </li>
                  <li class="layui-nav-item">
                    <a href="<?php echo U('Detail/Session');?>"><i class="fa fa-info fa-fw"></i>&nbsp;注销</a>
                </li>
            </ul>
            <!-- 手机和平板的导航开关 -->
            ...
            <div class="blog-main">
                ...
                <div class="home-tips shadow">
                    ...
                    <div class="home-tips-container">
                        <span style="color: #009688">本博客属于个人博客！</span>
                ...
                <?php if(is_array($are)): foreach($are as $key=>$v): ?><div class="article shadow">
                        <div class="article-left">
                            <img src="<?php echo ($v["blog_img"]); ?>" alt="<?php echo ($v["blog_title"]); ?>" />
                        </div>
                        <div class="article-right">
                            <div class="article-title">
                    <a id="onl" idd="<?php echo ($v["blog_id"]); ?>" href="<?php echo U('Detail/detail_Show');?>?id=<?php echo ($v["blog_id"]); ?>"><?php echo ($v["blog_title"]); ?></a>
                            </div>
                            <div class="article-abstract">
                                <?php echo ($v["blog_contre"]); ?>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="article-footer">
                            <span><i class="fa fa-clock-o"></i>&nbsp;&nbsp;<?php echo (date('Y-m-d H:i:s',$v["blog_time"])); ?></span>
                            <span class="article-author"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo ($v["blog_author"]); ?></span>
                          <?php if(is_array($v["la_name"])): foreach($v["la_name"] as $key=>$p): ?><span><i class="fa fa-tag"></i>&nbsp;&nbsp;<a href="#"><?php echo ($p); ?></a></span><?php endforeach; endif; ?>
                            <span class="article-viewinfo"><i class="fa fa-eye"></i>&nbsp;<?php echo ($v["blog_sum"]); ?></span>
...
<script type="text/javascript">
                $(document).on('click',"#onl",function(){
                    ...
                    $.get("<?php echo U('Detail/article_Sum');?>",{'id':id},function(msg){
