...
<html xmlns="http://www.onele.cc/1997/xhtml">
<head>
    <meta charset="utf-8" />
    <title>Zy后台管理系统</title>
    <link rel="shortcut icon" href="" type="image/x-icon">
    <!-- layui.css -->
    <link href="/Public/bluo/plugin/layui/css/layui.css" rel="stylesheet" />
    <!-- font-awesome.css -->
    <link href="/Public/bluo/plugin/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <!-- animate.css -->
    <link href="/Public/bluo/css/animate.min.css" rel="stylesheet" />
    <!-- 本页样式 -->
    <link href="/Public/bluo/css/main.css" rel="stylesheet" />
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            <div class="ht-console">
                <div class="ht-user">
                    <img src="http://blog.com/Public/updat/1502784670.jpg" />
            ...
            <ul class="ht-nav">
                <li class="ht-nav-item">
                    <a target="_blank" href="http://blog.com/index.php">前台入口</a>
                </li>
                 <li class="ht-nav-item">
                    <a  href="<?php echo U('Clear/aw_Ay');?>">清除缓存</a>
                </li>
                <li class="ht-nav-item">
                    <a href="javascript:;" id="individuation"><i class="fa fa-tasks fa-fw" style="padding-right:5px;"></i>个性化</a>
                </li>
                <li class="ht-nav-item">
                    <a href="<?php echo U('Index/unse');?>"><i class="fa fa-power-off fa-fw"></i>注销</a>
                </li>
            </ul>
        </div>
        <!--侧边导航-->
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="<?php echo U('Article/article_show');?>" data-id="1">文章管理</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Article/article_add');?>" data-id="2">文章添加</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Article/article_sort');?>" data-id="3">文章分类</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Article/article_label');?>" data-id="4">标签管理</a></dd>
                            <dd><a href="javascript:;"  data-url="<?php echo U('Log/log_show');?>" data-id="5">管理员日志</a></dd>
                             <dd><a href="javascript:;"  data-url="<?php echo U('Article/article_recy');?>" data-id="6">博文回收站</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-user"></i>用户管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="<?php echo U('Login/adm_show');?>"  data-id="7">全部用户</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Login/register');?>"  data-id="8">黑名单管理</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-wrench"></i>扩展管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;"  data-url="<?php echo U('Conf/conf');?>" data-id="9">网站配置</a></dd>
                            <dd><a href="javascript:;" data-url="<?php echo U('Link/link');?>" data-id="10">友情链接</a></dd>
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <p style="padding: 10px 15px; margin-bottom: 20px; margin-top: 10px; border:1px solid #ddd;display:inline-block;">
                            上次登陆
                            <span style="padding-left:1em;">IP：<?php echo ($are["adm_ip"]); ?></span>
                            <span style="padding-left:1em;">地点：北京</span>
                            <span style="padding-left:1em;">时间：<?php echo ($are["adm_last_time"]); ?></span>
                        </p>
        ...
        <div class="layui-footer">
            <p style="line-height:44px;text-align:center;">凡阁后台管理系统 - Design By Zy</p>
        </div>
        <!--快捷菜单-->
